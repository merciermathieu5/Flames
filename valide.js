...
const ATTENDU = {
  equipe: 'CALGARY',
  taille: 24,
  echantillon: {nom: 'Brad Marchand', salaire: 7500000, ct: 0, ov: 81},
  masseSousContrat: 42150000,
  nbSousContrat: 9,
  dateSecours: '1er août 2026',
  nbEchus: 15,
  nbBackups: 0,
  masseTotale: 89050000
};
...
(async () => {
  ...
  W.localStorage.removeItem('cgy_resignatures_v1');
  W.localStorage.removeItem('cgy_transac_v1');
